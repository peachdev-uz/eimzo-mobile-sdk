...
[![Version](https://img.shields.io/badge/version-1.2.8-blue.svg)](https://github.com/peachdev-uz/eimzo-mobile-sdk/releases)
...
📥 **[eimzo-sdk-1.2.8.aar](android/eimzo-sdk-1.2.8.aar)** (11 MB) — to'liq UI bundlanган
...
Yuklab olish: **[android/eimzo-sdk-1.2.8.aar](android/eimzo-sdk-1.2.8.aar)** (11 MB)

### 2. `app/build.gradle`
```gradle
dependencies {
    implementation files('libs/eimzo-sdk-1.2.8.aar')
...
So'nggi versiya: **[1.2.8](https://github.com/peachdev-uz/eimzo-mobile-sdk/releases/tag/v1.2.8)** (2026-06-12)
