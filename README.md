...
[![Version](https://img.shields.io/badge/version-1.2.3-blue.svg)](https://github.com/peachdev-uz/eimzo-mobile-sdk/releases)
...
📥 **[eimzo-sdk-1.2.3.aar](android/eimzo-sdk-1.2.3.aar)** (989 KB) — to'liq UI bundlanган
...
Yuklab olish: **[android/eimzo-sdk-1.2.3.aar](android/eimzo-sdk-1.2.3.aar)** (1.0 MB)

### 2. `app/build.gradle`
```gradle
dependencies {
    implementation files('libs/eimzo-sdk-1.2.3.aar')
...
So'nggi versiya: **[1.2.3](https://github.com/peachdev-uz/eimzo-mobile-sdk/releases/tag/v1.2.3)** (2026-06-09)
