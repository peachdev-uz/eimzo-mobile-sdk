...
[![Version](https://img.shields.io/badge/version-2.1.0-blue.svg)](https://github.com/peachdev-uz/eimzo-mobile-sdk/releases)
...
📥 **[eimzo-sdk-2.1.0.aar](android/eimzo-sdk-2.1.0.aar)** (12 MB) — to'liq UI bundlangan
...
dependencies {
    implementation 'uz.eimzo:eimzo-sdk:2.1.0'
}
```
...
Yuklab olish: **[android/eimzo-sdk-2.1.0.aar](android/eimzo-sdk-2.1.0.aar)** (12 MB)

### 2. `app/build.gradle`
```gradle
dependencies {
    implementation files('libs/eimzo-sdk-2.1.0.aar')
...
So'nggi versiya: **[2.1.0](https://github.com/peachdev-uz/eimzo-mobile-sdk/releases/tag/v2.1.0)** (2026-08-26)
