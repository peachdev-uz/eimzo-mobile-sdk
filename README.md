...
[![Version](https://img.shields.io/badge/version-1.1.0-blue.svg)](https://github.com/peachdev-uz/eimzo-mobile-sdk/releases)
...
📥 **[eimzo-sdk-1.1.0.aar](android/eimzo-sdk-1.1.0.aar)** (995 KB) — to'liq UI bundlanган
...
dependencies {
    implementation 'uz.eimzo:eimzo-sdk:1.1.0'
}
```
...
Yuklab olish: **[android/eimzo-sdk-1.1.0.aar](android/eimzo-sdk-1.1.0.aar)** (995 KB)

### 2. `app/build.gradle`
```gradle
dependencies {
    implementation files('libs/eimzo-sdk-1.1.0.aar')
...
So'nggi versiya: **[1.1.0](https://github.com/peachdev-uz/eimzo-mobile-sdk/releases/tag/v1.1.0)** (2026-06-05)
